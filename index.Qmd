...
subtitle: "ovvero il buono, il brutto, e il cattivo del testing psicologico"
...
## Quali casi esempi vediamo ora...

<span style="font-size:35px;">Cosa sappiamo, cosa non sappiamo, e quali problemi se non abbiamo informazioni importanti su alcuni strumenti di ampio uso per casistiche frequenti:</span>
...
La versione per prescolari (WPPSI-IV) potrebbe anch'essa sovrastimare, secondo <a href="https://drive.google.com/file/d/19fpOWGMiPXaD0zLDvAipXIcJlP3wLhpq/view" target="_blanks">un recente report</a>, per motivi diversi
...
- Il *"campione totale (N = 1025)"* include 20% casi clinici (disturbi del neurosviuppo; n = 201) in quali in base a Tabella 3-7 potrebbero avere QI medio $\approx 85$ 
...
- prova computerizzata, *scoring online*; manuale **fornisce descrittive basate solo su continuous norming, non quelle osservate** per indici principali (non per sottoindici); da confronto coi clinici emerge che **piattaforma di <em>scoring</em> NON restituisce punteggi grezzi dei pazienti**!
